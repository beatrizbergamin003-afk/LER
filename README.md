...
Este documento espesifica os requisistos funcionais e não-funcionais para o Sistema de Gestão de Tarefas (SGT), seguindo o padrão IEEE 29148:2018.

### 1.2 Escopo

O SGT permitirá que usuários criem, organizem e acompanhem tarefas pessoais e profissionais com sistema de prioridade prazos.

### 1.3 Definição e Acrônimos 

- **SGT**: Sistema de Gestão de Gestão de Tarefas
...
- {} Validação de data (não peritir datas passadas)
...
**Descrição**: O Sisitema deve implementar autencação OAuth 2.0 e criptografia TLS 1.3.
**Categoria**: Segurança.
**Prioridade**: Crítica.
...
## 4. Contole de Versões

### 4.1 Histórico de Alterações
 | Versão | Data | Autor | Modificação |
 |--------|------|-------|-------------|
 | 1.0 | 2026-03-27 | Equipe de Análise | Versão incial do documento |
